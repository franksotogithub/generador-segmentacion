...
EscudoNacional = r'D:\Dropbox\imagenes\Escudo_BN.png'
...
#   DECLARANDO LAS VARIABLES QUE CONTIENEN LA FUENTE DE INFORMACION
def ListadoAEU(info , output,flag_desastre=0):
    cab=info[0]
    data =info[1]
    ...
    if flag_desastre==0:
        ...
        SubTitulo = Paragraph(u'<strong>LISTADO DE VIVIENDAS DEL AREA DE EMPADRONAMIENTO URBANO</strong>', h_sub_tile_2)
    else:
        Titulo = Paragraph(u'CENSOS DE LAS ÁREAS AFECTADAS POR EL<BR/>FENÓMENO DEL NIÑO COSTERO',h_sub_tile)
        SubTitulo = Paragraph(u'<strong>LISTADO DE VIVIENDAS DEL AREA DE EMPADRONAMIENTO </strong>', h_sub_tile_2)


    CabeceraPrincipal = [[ Titulo,'',''],
                         [Image(EscudoNacional, width=50, height=50), SubTitulo, Image(LogoInei, width=55, height=50)]]
    ...
    if (flag_desastre)==0:
        Filas = [
        ['', '', '', '',  Paragraph('<b>Doc.CPV.03.20</b>', h111),''],
        [ Paragraph(u'<b>A. UBICACIÓN GEOGRÁFICA</b>',h11), '', '', '', Paragraph(u'<b>B. UBICACIÓN CENSAL</b>',h11), ''],
        [Paragraph(u'<b>DEPARTAMENTO</b>', h1), u'{}'.format(coddep), u'{}'.format(departamento), '', Paragraph(u'<b>ZONA Nº</b>', h1),u'{}'.format(zona), Paragraph(u'<b>SUB ZONA</b>', h1),u'{}'.format(subzona)],
        [Paragraph(u'<b>PROVINCIA</b>', h1), u'{}'.format(codprov), u'{}'.format(provincia), '', Paragraph(u'<b>SECCIÓN Nº</b>', h1), '',u'{}'.format(seccion),'' ],
        [Paragraph(u'<b>DISTRITO</b>', h1), u'{}'.format(coddist), u'{}'.format(distrito), '', Paragraph(u'<b>A.E.U. Nº</b>', h1),'', u'{}'.format(aeus),''],
        ...
        Tabla = Table(Filas, colWidths=[3.7 * cm, 1 * cm, 8.1 * cm, 0.3 * cm, 2 * cm, 1.7 * cm, 2 * cm, 1 * cm],
        ...
        Tabla.setStyle(TableStyle([
            ...
            ('ALIGN', (5, 2), (5, 6), 'CENTER'),
            ('ALIGN', (6, 3), (7, 6), 'CENTER'),
            ('ALIGN', (0, 1), (-1, 1), 'CENTER'),
            ('VALIGN', (0, 0), (-1, -2), 'MIDDLE'),
            ('FONTSIZE', (0, 0), (-1, -1), 8),
            ('GRID', (0, 1), (2, 6), 1, colors.black),
            ('GRID', (4, 1), (7, 4), 1, colors.black),
            ('GRID', (4, 6), (7, 6), 1, colors.black),
            ('SPAN', (4, 0), (7, 0)),
            ('SPAN', (0, 1), (2, 1)),
            ('SPAN', (4, 1), (7, 1)),
            ('SPAN', (4, 3), (5, 3)),
            ...
            ('SPAN', (6, 6), (7, 6)),
            ('SPAN', (1, 6), (2, 6)),
            ('BACKGROUND', (0, 1), (0, 6), colors.Color(220.0 / 255, 220.0 / 255, 220.0 / 255)),
            ('BACKGROUND', (0, 1), (2, 1), colors.Color(220.0 / 255, 220.0 / 255, 220.0 / 255)),
            ('BACKGROUND', (4, 1), (7, 1), colors.Color(220.0 / 255, 220.0 / 255, 220.0 / 255)),
            ('BACKGROUND', (4, 3), (5, 4), colors.Color(220.0 / 255, 220.0 / 255, 220.0 / 255)),
            ('BACKGROUND', (4, 6), (4, 6), colors.Color(220.0 / 255, 220.0 / 255, 220.0 / 255)),
        ...
        Filas = [
            ...
            [Paragraph(u'<b>DEPARTAMENTO</b>', h1), u'{}'.format(coddep), u'{}'.format(departamento), '',
             Paragraph(u'<b>ZONA Nº</b>', h1),'', u'{}'.format(zona),''],
            [Paragraph(u'<b>PROVINCIA</b>', h1), u'{}'.format(codprov), u'{}'.format(provincia), '',
             Paragraph(u'<b>SECCIÓN Nº</b>', h1), '', u'{}'.format(seccion), ''],
            [Paragraph(u'<b>DISTRITO</b>', h1), u'{}'.format(coddist), u'{}'.format(distrito), '',
             Paragraph(u'<b>A.E. Nº</b>', h1), '', u'{}'.format(aeus), ''],
            [Paragraph(u'<b>CENTRO POBLADO</b>', h1), u'{}'.format(codccpp), u'{}'.format(nomccpp), '', '', '', '', ''],
            [Paragraph(u'<b>CATEGORÍA DEL CENTRO POBLADO</b>', h1), u'{}'.format(catccpp), '', '',
             Paragraph(u'<b>TOTAL DE VIVIENDAS/ESTABLECIMIENTOS DEL AE.</b>', h1), '', '{}'.format(viviendas), '']
        ]

        Tabla = Table(Filas, colWidths=[3.7 * cm, 1 * cm, 6.3 * cm, 0.3 * cm, 2 * cm, 1.7 * cm, 2 * cm, 1 * cm],
                  rowHeights=[0.4 * cm, 0.4 * cm, 0.4 * cm, 0.4 * cm, 0.4 * cm, 0.4 * cm, 0.7 * cm])
    ...
    if flag_desastre==0:
        Filas2 = [
            [Paragraph(e, h3) for e in [u"<strong>Viv Nº</strong>", u"<strong>Mz Nº</strong>", u"<strong>Frent Nº</strong>", u"<strong>DIRECCIÓN DE LA VIVIENDA</strong>", "", "", "", "", "", "", "", "", u"<strong>Nombres y Apellidos del<br/>JEFE DEL HOGAR</strong>"]],
            ...
            [Paragraph(e, h3) for e in [u"<strong>(1)</strong>", u"<strong>(2)</strong>", u"<strong>(3)</strong>", u"<strong>(4)</strong>", u"<strong>(5)</strong>", u"<strong>(6)</strong>", u"<strong>(7)</strong>", u"<strong>(8)</strong>", u"<strong>(9)</strong>", u"<strong>(10)</strong>", u"<strong>(11)</strong>", u"<strong>(12)</strong>", u"<strong>(13)</strong>"]]
             ]


        Tabla2 = Table(Filas2, colWidths = [0.8 * cm, 0.8 * cm, 1 * cm, 1.2 * cm, 3.5 * cm, 1.2 * cm, 1.1 * cm, 0.8 * cm, 1 * cm, 1 * cm, 0.9 * cm, 0.9 * cm, 5.6 * cm])
        ...
        if nrows > 19:
            HojaRegistros = contar_registros(nrows,19,26)

            HojaRegistros.append((0, 19))
            ...
            for rangos in HojaRegistros:
                ...
                #for viv in ([x for x in arcpy.da.SearchCursor(VIV_fc, ListFields, "LLAVE_AEU = '{}'".format(identificador))])[rangos[0]:rangos[1]]:
                    ...
                    registros = [[vivn, mzinei,  frente, tvia, Paragraph(u'{}'.format(nomvia), h4), npuerta, block, mzmuni, lote, piso, interior, kmn, Paragraph(u'{}'.format(jefehogar), h4)]]

                    RegistrosIngresados = Table(registros,
                              colWidths = [0.8 * cm, 0.8 * cm, 1 * cm, 1.2 * cm, 3.5 * cm, 1.2 * cm, 1.1 * cm, 0.8 * cm, 1 * cm, 1 * cm, 0.9 * cm, 0.9 * cm, 5.6 * cm],
                              rowHeights=[1 * cm])
            ...
            #for viv in ([x for x in arcpy.da.SearchCursor(VIV_fc, ListFields, "LLAVE_AEU = '{}'".format(identificador))]):
                ...
                registros = [[vivn, mzinei, frente, tvia, Paragraph(u'{}'.format(nomvia), h4), npuerta, block, mzmuni, lote, piso,interior, kmn, Paragraph(u'{}'.format(jefehogar), h4)]]
                RegistrosIngresados = Table(registros,
                                        colWidths=[0.8 * cm, 0.8 * cm, 1 * cm, 1.2 * cm, 3.5 * cm, 1.2 * cm, 1.1 * cm,
                                                   0.8 * cm, 1 * cm, 1 * cm, 0.9 * cm, 0.9 * cm, 5.6 * cm],
                                        rowHeights=[1 * cm])
                RegistrosIngresados.setStyle(TableStyle([
                        ('GRID', (0, 0), (-1, -1), 1, colors.black),
                        ('FONTSIZE', (0, 0), (-1, -1), 7),
        ...
        Filas2 = [
            [Paragraph(e, h3) for e in
             [u"<strong>Viv Nº</strong>", u"<strong>Mz Nº</strong>", u"<strong>Frent Nº</strong>",
              u"<strong>DIRECCIÓN DE LA VIVIENDA</strong>", "", "", "", "", "", "", "", "",
              u"<strong>Nombres y Apellidos del<br/>JEFE DEL HOGAR</strong>",u"Viv. Afectada <br/>1.Si<br/>2.No"]],
            [Paragraph(e, h3) for e in ["", "", "", u"<strong>Tipo de Vía</strong>", u"<strong>Nombre de Vía</strong>",
                                        ...
                                        u"<strong>Mz Nº</strong>", u"<strong>Lote Nº</strong>",
                                        u"<strong>Piso Nº</strong>", u"<strong>Int. Nº</strong>",
                                        u"<strong>Km. Nº</strong>", "",""]],
            [Paragraph(e, h3) for e in
             [u"<strong>(1)</strong>", u"<strong>(2)</strong>", u"<strong>(3)</strong>", u"<strong>(4)</strong>",
              ...
              u"<strong>(13)</strong>", u"<strong>(14)</strong>"]]
        ]

        Tabla2 = Table(Filas2,
                       colWidths=[0.8 * cm, 0.8 * cm, 1 * cm, 1.2 * cm, 3.5 * cm, 1.2 * cm, 1.1 * cm, 0.8 * cm, 1 * cm,
                                  1 * cm, 0.9 * cm, 0.9 * cm, 4.6 * cm,1.5*cm])
        ...
        if nrows > 19:
            ...
            for rangos in HojaRegistros:
                ...
                for viv in (data)[rangos[0]:rangos[1]]:
                    ...
                    registros = [
                        [vivn, mzinei, frente, tvia, Paragraph(u'{}'.format(nomvia), h4), npuerta, block, mzmuni, lote,
                         piso, interior, kmn, Paragraph(u'{}'.format(jefehogar), h4),""]]

                    RegistrosIngresados = Table(registros,
                                                colWidths=[0.8 * cm, 0.8 * cm, 1 * cm, 1.2 * cm, 3.5 * cm, 1.2 * cm,
                                                           1.1 * cm, 0.8 * cm, 1 * cm, 1 * cm, 0.9 * cm, 0.9 * cm,
                                                           4.6 * cm,1.5*cm],
                                                rowHeights=[1 * cm])
            ...
            for viv in (data):
                ...
                RegistrosIngresados = Table(registros,
                                            colWidths=[0.8 * cm, 0.8 * cm, 1 * cm, 1.2 * cm, 3.5 * cm, 1.2 * cm,
                                                       1.1 * cm,
                                                       0.8 * cm, 1 * cm, 1 * cm, 0.9 * cm, 0.9 * cm, 4.6 * cm,1.5*cm],
                                            rowHeights=[1 * cm])
                RegistrosIngresados.setStyle(TableStyle([
                    ('GRID', (0, 0), (-1, -1), 1, colors.black),
                    ('FONTSIZE', (0, 0), (-1, -1), 7),
    ...
    if flag_desastre==0:
        ...
        PiePagina = [[Paragraph(u'{}'.format("EMPADRONADOR"), h5)],
                 [Paragraph('{}'.format("Todas las viviendas que estén dentro de los límites de tu A.E.U. deben ser empadronadas. Debes tener cuidado de no omitir ninguna vivienda"), h5)]]

    else:
        PiePagina = [[Paragraph(u'{}'.format("EMPADRONADOR"), h5)],
                     [Paragraph('{}'.format(
                         "Todas las viviendas que estén dentro de los límites de tu A.E. deben ser empadronadas. Debes tener cuidado de no omitir ninguna vivienda"),
                                h5)]]

    Tabla_Pie = Table(PiePagina, colWidths = [20 * cm],rowHeights=[0.8 * cm,1.6* cm])
...
def ListadoSeccion(info, output):
    cab=info[0]
    data=info[1]
    ...
    Titulo = Paragraph(u'CENSOS NACIONALES 2017: XII DE POBLACIÓN, VII DE VIVIENDA Y III DE COMUNIDADES INDÍGENAS <br/> III Censo de Comunidades Nativas y I Censo de Comunidades Campesinas',h_sub_tile)
    SubTitulo = Paragraph(u'<strong>LISTADO DE LA SECCIÓN CENSAL URBANA POR ÁREAS DE EMPADRONAMIENTO, MANZANAS Y VIVIENDAS</strong>', h_sub_tile_2)
    ...
    Filas = [
        ['', '', '', '',  Paragraph('<b>Doc.CPV.03.206</b>', h111),''],
        [ Paragraph(u'<b>A. UBICACIÓN GEOGRÁFICA</b>',h11), '', '', '', Paragraph(u'<b>B. UBICACIÓN CENSAL</b>',h11), ''],
        [Paragraph(u'<b>DEPARTAMENTO</b>', h1), u'{}'.format(coddep), u'{}'.format(departamento), '', Paragraph(u'<b>ZONA Nº</b>', h1),u'{}'.format(zona), Paragraph(u'<b>SUB ZONA</b>', h1),u'{}'.format(subzona)],
        [Paragraph(u'<b>PROVINCIA</b>', h1), u'{}'.format(codprov), u'{}'.format(provincia), '', Paragraph(u'<b>SECCIÓN Nº</b>', h1), '',u'{}'.format(seccion),'' ],
        [Paragraph(u'<b>DISTRITO</b>', h1), u'{}'.format(coddist), u'{}'.format(distrito), '', Paragraph(u'<b>A.E.U. Nº</b>', h1),'', u'{}'.format(aeus),''],
        [Paragraph(u'<b>CENTRO POBLADO</b>', h1), u'{}'.format(codccpp), u'{}'.format(nomccpp), '', '', '','',''],
        [Paragraph(u'<b>CATEGORÍA DEL CENTRO POBLADO</b>', h1), u'{}'.format(catccpp), '', '',Paragraph(u'<b>C. TOTAL DE VIVIENDAS<br/>DE LA SECCION</b>', h1),'','{}'.format(viviendas),'']
    ...
    CabeceraSecundaria = [
        [Paragraph(e, h3) for e in [u"<strong> D. INFORMACIÓN DE LA SECCIÓN CENSAL URBANA</strong>", "", "", ]],
        [Paragraph(e, h3) for e in [u"<strong>A.E.U. Nº</strong>", u"<strong>MANZANA Nº</strong>",
                                    u"<strong>Nº DE VIVIENDAS POR A.E.U.</strong>"]]
    ]
    Tabla1 = Table(CabeceraSecundaria, colWidths=[4 * cm,  10* cm, 4 * cm])
    ...
    for el in data:
        ...
        Registros = [[Paragraph(e, h3) for e in [ u'{}'.format(aeu).zfill(3), u'{}'.format(manzanas), u'{}'.format(viviendas_aeu)]]]

        Tabla2 = Table(Registros, colWidths=[4 * cm,  10* cm, 4 * cm])
...
def ListadoZona(informacion, output,flag_desastre=0):
    cab=informacion[0]
    data = informacion[1]
    ...
    if flag_desastre==0:
        ...
        Titulo = Paragraph(u'CENSOS NACIONALES 2017: XII DE POBLACIÓN, VII DE VIVIENDA Y III DE COMUNIDADES INDÍGENAS <br/> III Censo de Comunidades Nativas y I Censo de Comunidades Campesinas',h_sub_tile)
        SubTitulo = Paragraph(u'<strong>LISTADO DE LA ZONA CENSAL POR SECCIONES Y ÁREAS DE EMPADRONAMIENTO URBANO</strong>', h_sub_tile_2)
    else:

        Titulo = Paragraph(u'CENSOS DE LAS ÁREAS AFECTADAS POR EL<BR/>FENÓMENO DEL NIÑO COSTERO', h_sub_tile)
        SubTitulo = Paragraph(u'<strong>LISTADO DE LA ZONA CENSAL POR SECCIONES Y ÁREAS DE EMPADRONAMIENTO</strong>', h_sub_tile_2)
    ...
    if flag_desastre==0:
        Filas = [
        ['', '', '', '',  Paragraph('<b>Doc.CPV.03.204</b>', h111),''],
        [ Paragraph(u'<b>A. UBICACIÓN GEOGRÁFICA</b>',h11), '', '', '', Paragraph(u'<b>B. UBICACIÓN CENSAL</b>',h11), ''],
        [Paragraph(u'<b>DEPARTAMENTO</b>', h1), u'{}'.format(coddep), u'{}'.format(departamento), '', Paragraph(u'<b>ZONA Nº</b>', h1),u'{}'.format(zona), Paragraph(u'<b>SUB ZONA</b>', h1),u'{}'.format(subzona)],
        [Paragraph(u'<b>PROVINCIA</b>', h1), u'{}'.format(codprov), u'{}'.format(provincia), '', Paragraph(u'<b>SECCIÓN Nº</b>', h1), '',u'{}'.format(secciones),'' ],
        [Paragraph(u'<b>DISTRITO</b>', h1), u'{}'.format(coddist), u'{}'.format(distrito), '', Paragraph(u'<b>A.E.U. Nº</b>', h1),'', u'{}'.format(aeus),''],
        [Paragraph(u'<b>CENTRO POBLADO</b>', h1), u'{}'.format(codccpp), u'{}'.format(nomccpp), '', '', '','',''],
        [Paragraph(u'<b>CATEGORÍA DEL CENTRO POBLADO</b>', h1), u'{}'.format(catccpp), '', '',Paragraph(u'<b>TOTAL DE VIVIENDAS<br/>DE LA ZONA</b>', h1),'','{}'.format(viviendas),'']
        ...
        Filas = [
            ...
            [Paragraph(u'<b>A. UBICACIÓN GEOGRÁFICA</b>', h11), '', '', '',
             Paragraph(u'<b>B. UBICACIÓN CENSAL</b>', h11), ''],
            [Paragraph(u'<b>DEPARTAMENTO</b>', h1), u'{}'.format(coddep), u'{}'.format(departamento), '',
             Paragraph(u'<b>ZONA Nº</b>', h1),'', u'{}'.format(zona),''],
            [Paragraph(u'<b>PROVINCIA</b>', h1), u'{}'.format(codprov), u'{}'.format(provincia), '',
             Paragraph(u'<b>SECCIÓN Nº</b>', h1), '', u'{}'.format(secciones), ''],
            [Paragraph(u'<b>DISTRITO</b>', h1), u'{}'.format(coddist), u'{}'.format(distrito), '',
             Paragraph(u'<b>A.E. Nº</b>', h1), '', u'{}'.format(aeus), ''],
            [Paragraph(u'<b>CENTRO POBLADO</b>', h1), u'{}'.format(codccpp), u'{}'.format(nomccpp), '', '', '', '', ''],
            [Paragraph(u'<b>CATEGORÍA DEL CENTRO POBLADO</b>', h1), u'{}'.format(catccpp), '', '',
             Paragraph(u'<b>TOTAL DE VIVIENDAS/ESTABLECIMIENTOS DE LA ZONA</b>', h1), '', '{}'.format(viviendas), '']
    ...
    if flag_desastre==0:
        CabeceraSecundaria = [
        [Paragraph(e, h3) for e in [u"<strong> C. INFORMACIÓN DE LA SECCIÓN CENSAL URBANA</strong>", "", "",""]],
        [Paragraph(e, h3) for e in [u"<strong>SECCIÓN Nº</strong>",u"<strong>A.E.U. Nº</strong>", u"<strong>MANZANA Nº</strong>",
                                    u"<strong>Nº DE VIVIENDAS POR A.E.U.</strong>"]]
        ]
    else:
        CabeceraSecundaria = [
            [Paragraph(e, h3) for e in [u"<strong> D. INFORMACIÓN DE LA ZONA CENSAL </strong>", "", "", ""]],
            [Paragraph(e, h3) for e in
             [u"<strong>SECCIÓN Nº</strong>", u"<strong>A.E. Nº</strong>", u"<strong>MANZANA Nº</strong>",
              u"<strong>Nº DE VIVIENDAS POR A.E.</strong>"]]
        ]

    columnas= [2 * cm, 2 * cm, 10.5 * cm, 3.5 * cm]
    ...
    Elementos.append(Tabla1)
    #ListFields=["SECCION","AEU", "CANT_VIV"]

    #nrows = len([x[0] for x in arcpy.da.SearchCursor(data, ListFields)])
    nrows = len(data)
    ...
    if nrows > p:
        ...
        for x in data:
            ...
            Registros = [
                        [Paragraph(e, h3) for e in
                         [u'{}'.format(seccion), u'{}'.format(aeus), u'{}'.format(manzanas), u'{}'.format(viviendas_aeu)]]
                    ]
            ...
            if n_hoja==1:
                if contador_lineas>35:
                    n_hoja=n_hoja+1
                    Elementos.append(PageBreak())
                    Elementos.append(Tabla1)
                    contador_lineas=1
            else:
                if contador_lineas >47:
                    n_hoja = n_hoja + 1
                    Elementos.append(PageBreak())
                    Elementos.append(Tabla1)
                    contador_lineas = 1
        ...
        #HojaRegistros = contar_registros(nrows, p, 47)
        #HojaRegistros.append((0, p))
        #HojaRegistros.sort(key=lambda n: n[0])
#
        #for rangos in HojaRegistros:
        #    for x in data[rangos[0]:rangos[1]]:
        #        seccion=x[0]
        #        aeus = x[1]
        #        manzanas=x[2]
        #        viviendas_aeu = x[3]
...
#
    ...
    if flag_desastre==0:
        FilasPiePagina = [
                     [Paragraph(u'{}'.format(u"<strong>D. RESUMEN DE LA ZONA</strong>"),h3),''],
                     ...
                     [Paragraph(u'{}'.format(u"<strong>TOTAL DE AEUS</strong>"),h1), u'{}'.format(cat_aeus)]

                      ]

    else:
        FilasPiePagina = [
            [Paragraph(u'{}'.format(u"<strong>E. RESUMEN DE LA ZONA</strong>"), h3), ''],
            [Paragraph(u'{}'.format(u"<strong>TOTAL DE SECCIONES</strong>"), h1),u'{}'.format(cant_secc)],
            [Paragraph(u'{}'.format(u"<strong>TOTAL DE MANZANAS</strong>"), h1), u'{}'.format(cant_mzs)],
            [Paragraph(u'{}'.format(u"<strong>TOTAL DE ÁREAS DE EMPADRONAMIENTO</strong>"), h1), u'{}'.format(cat_aeus)]

        ]


    Tabla_Pie = Table(FilasPiePagina, colWidths=[6*cm,3.4 * cm], rowHeights=[0.5 * cm,0.5 * cm,0.5 * cm,0.5 * cm])
