...
path_urbano_croquis_listado= path_out_final+"\\reportes-distritales-urbanos-temp"
...
sql = """
    select distinct b.ubigeo from  dbo.TEMP_REPORTE_DISTRITAL b
    where b.fase='{fase}' and ubigeo like '15%'
    order by b.ubigeo
    """.format(fase=fase)
cursor.execute(sql)
